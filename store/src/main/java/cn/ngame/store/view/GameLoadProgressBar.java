...
public class GameLoadProgressBar extends View {
    ...
    public GameLoadProgressBar(Context context, AttributeSet attrs) {
        ...
        backgroundColor = context.getResources().getColor(R.color.download_bg2);
        //获取布局文件中的值
        ...
        frontColor = context.getResources().getColor(R.color.colorPrimary);
    ...
    public void setLoadState(GameFileStatus status){
        ...
        if (gameFileStatus == null || gameFileStatus.getStatus() == GameFileStatus.STATE_UN_INSTALL){
            ...
            //progress = 100;
            text = "安装";
        }else if(gameFileStatus.getStatus() == GameFileStatus.STATE_HAS_INSTALL || gameFileStatus.getStatus() == GameFileStatus.STATE_HAS_INSTALL_OLD){     //已经安装
            text = "打开";
        }
...
//        }
    ...
    public void toggle() {
        ...
        if (gameFileStatus == null || gameFileStatus.getStatus() == GameFileStatus.STATE_UN_INSTALL){
            ...
            installApp();
        }else if(gameFileStatus.getStatus() == GameFileStatus.STATE_HAS_INSTALL || gameFileStatus.getStatus() == GameFileStatus.STATE_HAS_INSTALL_OLD){ //已经安装，点击后打开APP
            openApp();
        }
