...
//            
//            RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams
// .FILL_PARENT);
//            
...
//		boolean onTop		= (dyTop > dyBottom) ? true : false;
        ...
        mWindow.showAtLocation(anchor, Gravity.NO_GRAVITY, x, h + y);
    }
    ...
    public void show(View parent, float screenX, float screenY) {
        ...
        Rect anchorRect = new Rect((int) screenX - widthAnchor / 2, (int) screenY - heightAnchor / 2, (int) screenX +
                widthAnchor / 2, (int) screenY + heightAnchor / 2);
    ...
    private void showArrow(int whichArrow, int requestedX) {
        ...
        showArrow.setVisibility(View.INVISIBLE);//设置箭头
