 ...
 */
public class SettingActivity extends BaseFgActivity implements CompoundButton.OnCheckedChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        layout_1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final DialogHelper dialogHelper = new DialogHelper(getSupportFragmentManager(),SettingActivity.this);
                dialogHelper.showAlert("请稍后...",true);
    ...
    private void doLoadClick(boolean isChecked){
        ...
        if(isChecked){
            ...
            dialogHelper.showConfirm("温馨提示", "运营商网络下载可能导致流量超额，确认开启？","取消","开启", new View.OnClickListener() {
                ...
                @Override
                public void onClick(View v) {
                    SPUtils.put(SettingActivity.this, Constant.CFG_ALLOW_4G_LOAD,true);
                }
            });
