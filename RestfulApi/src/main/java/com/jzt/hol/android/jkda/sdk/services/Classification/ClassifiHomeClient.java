...
public class ClassifiHomeClient extends PostMsgBaseClient<ClassifiHomeBean> {
    ...
    @Override
    protected Observable<ClassifiHomeBean> requestService(GameService askDoctorService) {
